...
interface TokenChopSpecInterface extends ethers.utils.Interface {
  functions: {
...
export class TokenChopSpec extends Contract {
  ...
  interface: TokenChopSpecInterface;
