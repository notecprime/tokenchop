...
interface TokenChopTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(uint8,address,address,address)": FunctionFragment;
...
export class TokenChopToken extends Contract {
  ...
  interface: TokenChopTokenInterface;
  ...
  functions: {
    ...
    sendCollateralToSister(
      _requestedAmount: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "sendCollateralToSister(uint256)"(
      _requestedAmount: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
